...
```
git clone https://github.com/CoinBlack/blackcore-lib
cd blackcore-lib
npm install
```
...
Blackcore-lib is a fork of bitcore-lib. The complete bitcore docs are hosted here: [bitcore documentation](http://bitcore.io/guide/). There's also a [bitcore API reference](http://bitcore.io/api/) available generated from the JSDocs of the project, where you'll find low-level details on each bitcore utility.
